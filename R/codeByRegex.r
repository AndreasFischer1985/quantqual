...
#' 
#' Adds code tags to certain regex-passages of a character vector.
#' @param corpus Character vector containing one document per element.
#' @details Adds code tags to certain regex-passages of a character vector.
#' @keywords text mining
#' @export
#' @examples
#' codeByRegex("hello world hello world hello world hello world","hello","code1")

codeByRegex <- function (corpus, passage, coding, context = 0, mess = T, assign = T, 
    subcorpus = NULL) 
{
    library(stringr)
